...
../Core/Src/Log.cpp \
../Core/Src/Rtc.cpp \
../Core/Src/communication_task.cpp \
../Core/Src/project_Init.cpp \
../Core/Src/project_main.cpp 
...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/Buzzer.d ./Core/Src/Buzzer.o ./Core/Src/Buzzer.su ./Core/Src/CliCommand.d ./Core/Src/CliCommand.o ./Core/Src/CliCommand.su ./Core/Src/CommTask.d ./Core/Src/CommTask.o ./Core/Src/CommTask.su ./Core/Src/DHT.d ./Core/Src/DHT.o ./Core/Src/DHT.su ./Core/Src/DateTime.d ./Core/Src/DateTime.o ./Core/Src/DateTime.su ./Core/Src/Flash.d ./Core/Src/Flash.o ./Core/Src/Flash.su ./Core/Src/Led.d ./Core/Src/Led.o ./Core/Src/Led.su ./Core/Src/Log.d ./Core/Src/Log.o ./Core/Src/Log.su ./Core/Src/Rtc.d ./Core/Src/Rtc.o ./Core/Src/Rtc.su ./Core/Src/communication_task.d ./Core/Src/communication_task.o ./Core/Src/communication_task.su ./Core/Src/freertos.d ./Core/Src/freertos.o ./Core/Src/freertos.su ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/project_Init.d ./Core/Src/project_Init.o ./Core/Src/project_Init.su ./Core/Src/project_main.d ./Core/Src/project_main.o ./Core/Src/project_main.su ./Core/Src/stm32l4xx_hal_msp.d ./Core/Src/stm32l4xx_hal_msp.o ./Core/Src/stm32l4xx_hal_msp.su ./Core/Src/stm32l4xx_hal_timebase_tim.d ./Core/Src/stm32l4xx_hal_timebase_tim.o ./Core/Src/stm32l4xx_hal_timebase_tim.su ./Core/Src/stm32l4xx_it.d ./Core/Src/stm32l4xx_it.o ./Core/Src/stm32l4xx_it.su ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32l4xx.d ./Core/Src/system_stm32l4xx.o ./Core/Src/system_stm32l4xx.su
